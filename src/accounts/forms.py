...
class ReactivateEmailForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if not qs.exists():
            ...
            msg = """
                This email does not exist, would you like to <a href = "{link}">register</a>?
    ...
    def clean(self):
        ...
        if qs.exists():
            ...
            if not_active.exists():
                ...
                reconfirm_msg = """Go to <a href='{resend_link}'> resend confrimation email</a>. """.format(resend_link = link)
