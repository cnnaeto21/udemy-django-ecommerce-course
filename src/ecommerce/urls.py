...
# from products.views import (ProductListView, product_list_view, ProductDetailView, 
#                             product_detail_view,
...
from .views import home_page, about_page, contact_page, profile_page

urlpatterns = [
    url(r'^$', home_page, name='home'),
    url(r'^about/$', about_page, name='about'),
    #url(r'^accounts/login/$', about_page, name='about'),
